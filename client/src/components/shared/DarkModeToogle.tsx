      ...
      <span className='relative h-6 w-12'>
        <span
          className={cn(
            ...
            theme === 'light' ? '-translate-y-4 opacity-0 blur-lg' : 'translate-y-0 opacity-100 blur-0'
          )}
        >
          Dark
        </span>
        <span
          className={cn(
            'absolute top-0 left-0 transition-all duration-1000',
            theme === 'dark' ? 'translate-y-4 opacity-0 blur-lg' : 'translate-y-0 opacity-100 blur-0'
          )}
        >
          Light
        </span>
