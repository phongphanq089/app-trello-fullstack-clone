    ...
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      <div className='text-center'>
        <Dialog.Trigger asChild>
          <button className='relative inline-flex w-[300px] max-w-xs items-center justify-between whitespace-nowrap rounded-lg  bg-color-2 py-3.5 pl-4 pr-3 text-sm text-white outline-none   focus-visible:border-indigo-400 focus-visible:bg-white focus-visible:ring-2 focus-visible:ring-indigo-100'>
            <div className='flex items-center justify-center'>
              <svg
                className='mr-3 h-4 w-4 shrink-0 fill-white'
                width={16}
                height={16}
                viewBox='0 0 16 16'
          ...
          <ScrollArea.Root className='max-h-[calc(85vh-44px)]'>
            <ScrollArea.Viewport className='h-full w-full'>
              <div className='space-y-4 px-2 py-4'>
                <div>
                  <div className='mb-2 px-2 text-xs font-semibold uppercase text-gray-400'>Recent</div>
                  <ul>
                    <li>
                      <Link
                ...
                <div>
                  <div className='mb-2 px-2 text-xs font-semibold uppercase text-gray-400'>Suggestions</div>
                  <ul>
                    <li>
                      <Link
                        className='flex items-center rounded-lg px-2 py-1 text-sm leading-6 text-slate-700 outline-none focus-within:bg-slate-100 hover:bg-slate-100'
